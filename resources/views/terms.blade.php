...
@section('content')
<div class="page-heading about-heading header-text" style="background-image: url('{{ asset('images/heading-5-1920x500.jpg') }}');">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Ensure a secure and enjoyable shopping experience for yourself and fellow users</h4>
              <h2>Terms</h2>
            </div>
          </div>
        </div>
